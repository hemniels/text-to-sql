# Pseudocode für das WherePredictor-Modell
class WherePredictor:
    def __init__(input_dim, output_dim, embedding_dim=64, hidden_dim=128):
        ...
        - output_dim: Anzahl der möglichen Bedingungen (z.B. 20 verschiedene Bedingungen).
    ...
    def forward(x):
        ...
        - Ausgabe: Wahrscheinlichkeiten für jede Bedingung.
        """
